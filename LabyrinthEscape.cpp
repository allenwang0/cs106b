 ...
 * CS106B Winter 2021
 * Assignment 8
 * This file includes paths out of my personal maze and my personal twisty maze.
 */
 ...
 */
const string MyName = "Allen";

/* Change these constants to contain the paths out of your mazes. */
const string ThePathOutOfMyMaze = "NWWSSNNWSSSEWNNNESESSEN";
const string ThePathOutOfMyTwistyMaze = "EEESSNSSWSN";
